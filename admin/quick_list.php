    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody id="quickListBody" class="divide-y divide-neutral-50 text-sm">
                <tr><td colspan="4" class="px-6 py-20 text-center text-neutral-400">Loading...</td></tr>
            </tbody>
        </table>
    </div>
    ...
    async function loadQuickList(page = 1) {
        ...
        try {
            ...
            if (!res.success || !res.data.leads.length) {
                tbody.innerHTML = `<tr><td colspan="4" class="px-6 py-20 text-center text-neutral-400">No leads found.</td></tr>`;
                return;
            }
            ...
            document.getElementById('quickListBody').innerHTML = `<tr><td colspan="4" class="px-6 py-20 text-center text-red-500">Error loading data.</td></tr>`;
        }
    }
