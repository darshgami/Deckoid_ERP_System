            ...
            <form id="leadForm" class="p-6 lg:p-8 max-h-[70vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between mt-6 pt-6 border-t border-neutral-100">
                    <div class="flex gap-3">
                        <button type="button" id="cancelBtn" onclick="closeLeadModal()" class="px-6 py-2 bg-neutral-100 text-neutral-600 font-bold rounded-xl hover:bg-neutral-200 transition-all text-sm hidden">
                            Cancel
                        </button>
