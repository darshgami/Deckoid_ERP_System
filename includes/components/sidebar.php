...
$menuItems = [
    ...
    ['label' => 'Add Lead', 'url' => 'leads.php?action=add', 'icon' => 'M12 4v16m8-8H4'],
    ...
    ['label' => 'Export Leads', 'url' => 'export.php', 'icon' => 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4'],
    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto custom-scrollbar">
            <?php foreach ($menuItems as $item): ?>
                <?php $isActive = ($current_page == $item['url'] || (isset($_GET['action']) && $item['url'] == $current_page . '?action=' . $_GET['action'])); ?>
            ...
            <div class="mt-auto pt-8">
                <a href="javascript:void(0)" onclick="logout()" class="group flex items-center gap-4 px-4 py-3.5 rounded-2xl text-neutral-400 hover:bg-red-50 hover:text-red-600 transition-all duration-200">
                    <div class="flex-shrink-0">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                        </svg>
                    </div>
                    <span class="font-semibold text-sm sidebar-text">Logout</span>
                </a>
            </div>
        </nav>

        <!-- User Profile Area -->
        <div class="p-6 border-t border-neutral-100 mt-auto">
            <div class="flex items-center gap-4 group">
                <div class="w-12 h-12 bg-primary-100 rounded-2xl flex-shrink-0 flex items-center justify-center text-primary-700 font-bold shadow-sm group-hover:shadow-md transition-all">
